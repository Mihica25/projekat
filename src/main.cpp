...
int main() {
    ...
    // load models
    // -----------
    Model ringModel("resources/objects/ring/10494_Regulation_Boxing_Ring_SG_V1_Max2011_it2.obj");
    ringModel.SetShaderTextureNamePrefix("material.");

    Model glovesModel("resources/objects/gloves/10493_Leather_Boxing_Gloves_V1_L3.obj");
    glovesModel.SetShaderTextureNamePrefix("material.");

    Model bagModel("resources/objects/boxingbag/frfrstnpnchbg.obj");
    bagModel.SetShaderTextureNamePrefix("material.");

    Model headgearModel("resources/objects/headgear/11718_boxing_headgear_v3_L3.obj");
    headgearModel.SetShaderTextureNamePrefix("material.");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        modelBag = glm::translate(modelBag, glm::vec3(27.0f,7.0f,27.0f));
        ...
        modelGloves = glm::translate(modelGloves, glm::vec3(20.0f, 1.0f ,30.0f));
        ...
        modelHeadgear = glm::translate(modelHeadgear, glm::vec3(17.0f,1.0f,32.0f));
...
//        glm::vec3 ColorLight = glm::vec3((float) sin(glfwGetTime() * 5.0),(float) sin(glfwGetTime() * 3.8),(float) sin(glfwGetTime() * 4.6));
        ...
        model = glm::translate(model, glm::vec3(-9.0f, 20.0f, 5.0f));
